...
params:
  studentID: "410773071"
  studentName: "李杰庭"
  repoURL: "https://github.com/talese20248/inclass-practice"
---
...
library(lubridata)
library(stringr)
str_c("1",allBankData$年月,"/01") -> dataTime
ymd(dataTime)+years(911) -> dataTime
allBankData$年月 <- dataTime
```
...
```{r ans33}
colnames($generic replacement)
str_locate($generic replacement)
```