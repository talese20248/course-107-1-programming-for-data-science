...
params:
  studentID: "410773071"
  studentName: "李杰庭"
  repoURL: "https://github.com/tpemartin/course-107-1-programming-for-data-science/tree/ce8ea53e588664a2db63289bf73d99015348cf01"
---
...
```{r ans13}
classData$`練2018-10-17-1` <- as.factor(classData$`練2018-10-17-1`)
StuDF$`練2018-10-17-1`[1] <- 有看公告 
StuDF$`練2018-10-17-1`[0] <- 沒看公告
```
...
```{r ans21}
hint: `lubridate::mdy_hms(Timestamp)
```
...
```{r ans23}
difftime(deadline-hwData$Timestap)
```
